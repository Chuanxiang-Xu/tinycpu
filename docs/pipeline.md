...
The v0.5 hardware still has one AXI-Lite master shared by instruction fetch and
...
Because only one instruction is active at a time in v0.5, data hazards are
